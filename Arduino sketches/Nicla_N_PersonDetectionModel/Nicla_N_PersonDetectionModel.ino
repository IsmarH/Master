...
void setup() {
 ...
 Serial.begin(BAUD_RATE_SERIAL_DATA);
  ...
  if ((model_input->dims->size != 3) || (model_input->dims->data[0] != 1) || (model_input->dims->data[1] != 50) || (model_input->dims->data[2] != kChannelNumber) || (model_input->type != kTfLiteFloat32)) {  //kChannelNumber
    TF_LITE_REPORT_ERROR(error_reporter,
