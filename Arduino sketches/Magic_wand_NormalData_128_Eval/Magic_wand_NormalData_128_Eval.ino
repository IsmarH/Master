...
//#include "tensorflow/lite/version.h"     //needs to be commented for new version
...
// Serial1.setTimeout(1);
  ...
  if ((model_input->dims->size != 4) || (model_input->dims->data[0] != 1) ||
      ...
      (model_input->dims->data[1] != 128) || (model_input->dims->data[2] != kChannelNumber) || (model_input->type != kTfLiteFloat32)) {
    TF_LITE_REPORT_ERROR(error_reporter,
